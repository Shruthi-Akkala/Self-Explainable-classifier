...
from transformers import AutoModel, AutoConfig, RobertaConfig, RobertaModel,BertConfig,BertModel,XLMRobertaConfig,XLMRobertaModel
...
class SEXLNet(LightningModule):
    def __init__(self, hparams):
        ...
        if self.hparams.model_name == "xlnet-base-cased":
        ...
        elif self.hparams.model_name == "gaunernst/bert-medium-uncased":
            config = BertConfig()
            print("in bert large SEXLNET")
            # self.model = RobertaModel.from_pretrained(self.hparams.model_name)
            model = BertModel.from_pretrained(self.hparams.model_name)
            ...
            self.model = XLMRobertaModel.from_pretrained(self.hparams.model_name)
    # Further configurations or modifications specific to XLM-RoBERTa if needed
    ...
    def forward(self, batch):
        ...
        if self.hparams.model_name == "xlnet-base-cased" or self.hparams.model_name == "bert-large-uncased":
