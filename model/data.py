...
import pandas as pd
from transformers import AutoTokenizer, RobertaTokenizer,BertTokenizer,XLMRobertaTokenizer
from tqdm import tqdm

from data_utils import pad_nt_matrix_roberta, pad_nt_matrix_xlnet,pad_nt_matrix_bert
...
class ClassificationData(pl.LightningDataModule):
    def __init__(self, basedir: str, tokenizer_name: str, batch_size: int, num_workers: int = 16):
        ...
        elif tokenizer_name == 'gaunernst/bert-medium-uncased':
...
class MyCollator(object):
    def __init__(self, model_name):
        ...
        if "xlnet" in model_name:
            ...
            self.pad_fn = pad_nt_matrix_bert
        else:
